...
API_URL2 = "https://api-inference.huggingface.co/models/kyungmin011029/code"
#code_category model api
API_URL3 = "https://api-inference.huggingface.co/models/kyungmin011029/category3"
...
def code_classifier(code, category):
  ...
  #result[0]['score']
    ...
    count = count.replace('LABEL_', '코드 ')
    check = check.replace('LABEL_', '')
    check = int(check)
    

    mapping_ = {'강력 일반폭력':0, '가정폭력':1, '살인': 2, '유기': 3, '변사' : 4, '총성/폭발음' : 5, '교통사고': 6, '납치': 7, '방화': 8, '일반폭력':9, '일반절도':10, '층간소음':11, '화재':12, '가출/실종': 13, '도박':14, '성매매/알선': 15, '과도노출': 16, '무허가주류/담배': 17, '무전취식':18, '보이스피싱': 19, '손괴': 20, '강제추행/강간': 21, '범행예고': 22, '시비난동행패소란': 23, '일반소음': 24, '적재물낙하': 25, '주취자보호': 26, '미귀가자': 27, '교통서비스': 28, '도박': 29, '미성년자고용/출입': 30, '공사장소음': 31, '분실물신고': 32, '습득신고': 33, '길안내': 34, '동물사체처리': 35, '전기누전' : 36, '수도관파열': 37, '불법주정차' : 38, '시설민원' : 39, '불법부착물': 40, '동물관련민원': 41, '면허증민원': 42, '금융범죄의심': 43, '불법번호판민원': 44, '공사장안전민원': 45, '쓰레기무단투기': 46 }
  # mapping_ = {'강력 일반폭력':0, '가정폭력':1, '일반폭력':2, '일반절도':3, '층간소음':4, '화재':5, '가출/실종': 6, '도박':7, '성매매/알선': 8, '과도노출': 9, '무허가주류/담배': 10, '무전취식':11, '보이스피싱': 12, '손괴': 13, '강제추행/강간': 14, '범행예고': 15, '시비난동행패소란': 16, '일반소음': 17, '적재물낙하': 18, '주취자보호': 19, '미귀가자': 20, '교통서비스': 21, '도박': 22, '미성년자고용/출입': 23, '공사장소음': 24, '분실물신고': 25, '습득신고': 26, '길안내': 27, '동물사체처리': 28, '전기누전' : 29, '수도관파열': 30, '불법주정차' : 31, '시설민원' : 32, '불법부착물': 33, '동물관련민원': 34, '면허증민원': 35, '금융범죄의심': 36, '불법번호판민원': 37, '공사장안전민원': 38, '쓰레기무단투기': 39 }
